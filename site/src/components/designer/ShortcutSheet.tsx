...
const SHORTCUTS = [
	...
	{ label: 'Place voxel', keys: 'Space / Draw + Click' },
	{ label: 'Paint stroke', keys: 'Draw + Drag / Space + Drag' },
	{ label: 'Erase voxel', keys: 'Erase / X / Right-click' },
	{ label: 'Rectangle fill', keys: 'Shift + Drag' },
	{ label: 'Pan viewport', keys: 'Move + Drag empty space / Middle-drag' },
	{ label: 'Zoom', keys: 'Pinch / + or − / Scroll' },
