...
export default function StatusBar({ cursor, selectedObjectName, view, onToggleShortcuts }: StatusBarProps) {
	...
	return (
		<footer className="designer-scroll flex min-w-0 items-center gap-4 overflow-x-auto whitespace-nowrap border-t border-border/80 bg-panel/90 px-3 py-2 text-sm text-muted md:px-5">
			...
			<a
				...
				className="ml-auto inline-flex items-center gap-1.5 rounded-full px-2 py-1 text-xs font-medium text-muted transition hover:bg-canvas hover:text-accent"
			>
			...
			<button
				...
				className="inline-flex size-6 items-center justify-center rounded-full text-muted transition hover:text-accent"
